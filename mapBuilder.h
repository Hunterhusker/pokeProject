...
// Entity methods
cell_t* placeEntity(map_t *screen, minHeap *mh, char type);
void delEntity(map_t *screen, minHeap *mh, cell_t *entity);
int moveEntity(map_t *screen, minHeap *mh, cell_t *entity, cell_t *player);
